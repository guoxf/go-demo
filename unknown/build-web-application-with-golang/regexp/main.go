...
func findIp(str string) string {

	return ipReg.FindString(str)
}
func findIps(str string) []string {
	return ipReg.FindAllString(str, -1)
}
...
func trimFileExt(fullFilename string) string {
