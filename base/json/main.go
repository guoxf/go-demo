...
func main() {
	...
	str = `{"A01":{"Id":1,"GiftType":"A01","Reward":[2,200],"StartDate":1438646400,"EndDate":1440201599,"Description":"12","Platform":"local","ServerId":"9"}}`
	m := make(map[string]GiftReward2)
